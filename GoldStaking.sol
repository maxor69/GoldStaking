...
import "https://github.com/maxor69/GoldStaking/$Robe.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721Receiver.sol";
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol";

contract GoldRobeStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, RobeCoin _token) { 
    nft = _nft;
    token = _token;
  }
